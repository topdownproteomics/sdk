...
namespace Test
{
    ...
    public static class ChemicalFormulaTestFixture
    {
        ...
        {
            Assert.Throws<TestLibException>(() => { ChemicalFormula.ParseFormula("!@#$"); }, "Input string for chemical formula was in an incorrect format");
        }
        ...
        {
            ChemicalFormula formulaA = ChemicalFormula.ParseFormula("CO");
            Assert.Throws<TestLibException>(() => { formulaA.NeutronCount(); }, "Cannot know for sure what the number of neutrons is!");
        }
