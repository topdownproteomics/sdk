...
public class Mercury7 : IIsotopicDistributionGenerator
{
    ...
    private readonly double _chargeCarrier;
    ...
    public Mercury7(double limit = 1E-26, double chargeCarrier = Utility.Proton)
    {
        _limit = limit;
        _chargeCarrier = chargeCarrier;
    }
    ...
    /// <returns>The isotopic distribution.</returns>
    ...
    /// <returns>The charged isotopic distribution.</returns>
    ...
    /// <returns>The list of charged isotopic distributions.</returns>
